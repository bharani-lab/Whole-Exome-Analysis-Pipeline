...
GENE_loc=-1 #
#
info_msg1_1="eyeVarP genef : Invalid number of inputs, must have three :" 
info_msg1_2="eyeVarP genef : 1) output destination directory + prefix" #
info_msg1_3="eyeVarP genef : 2) Input file - output from eyeVarP prioritisation process" 
info_msg1_4="eyeVarP genef : 3) Gene list" #
#
############################################################################################################
#
###########################################################################################################
...
#
	if (supplied_args != 5 ):  # arg [0] is the python program
		...
		eyeVarP_conf.gene_list=sys.argv[4] #
		eyeVarP_conf.final_output_file=eyeVarP_conf.output_dir+"gene_filtered_output_file_"+suffix+".txt" #
...
#	print ("filter_the_variants(): ") #
	#
#	print (eyeVarP_conf.input_file,eyeVarP_conf.final_output_file) # 
...
#					print "content-",content,"/",i				#
					if (content == eyeVarP_conf.GENE_NAME) : # 
...
#
	val=False #
	with open(eyeVarP_conf.gene_list,'r',encoding="utf-8") as gene_file : # 
